...
APP_ENV="${APP_ENV:-development}"  # Set to development for fks-dev server
    ...
    execute_ssh "
        ...
        if [ -n \"\\$GITHUB_TOKEN\" ]; then
            ...
            if git clone https://x-access-token:\\$GITHUB_TOKEN@github.com/nuniesmith/fks.git fks-fresh; then
                ...
                if git clone https://\\$GITHUB_TOKEN@github.com/nuniesmith/fks.git fks-fresh; then
                    ...
                    if git clone https://github.com/nuniesmith/fks.git fks-fresh; then
...
# Generated by deploy-application.sh for fks-dev server
# =================================================================
